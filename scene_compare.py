################################################################################
# This script compares the performance of fine-tuned, pre-trained LLaVA and human-evaluated meaning maps
# in terms of their correlations to the attentional maps generated by eye tracking
# and requires the following data file:
# 1. "result/human_meaning_maps"; -> meaning maps generated by human ratings
# 2. "result/llava_finetune_maps"; -> meaning maps generated by fine-tuned LLaVA
# 3. "result/llava_raw_maps"; -> meaning maps generated by pre-tuned (raw) LLaVA

# the output will be the following data file:
# "scene_comparisons.pdf"
